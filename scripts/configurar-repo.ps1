...
$etiquetas = @(
  ...
  @{ n='tema: informes';               c='BFD4F2'; d='Informes, tableros y reportes' },
  @{ n='tema: movil';                  c='BFD4F2'; d='Uso desde el celular' },
  @{ n='tema: integraciones';          c='BFD4F2'; d='Conectar con el ERP u otro sistema' },
  @{ n='tema: automatizacion';         c='BFD4F2'; d='Quitar trabajo manual repetitivo' },
  @{ n='tema: inteligencia artificial';c='BFD4F2'; d='Lectura de documentos, asistentes' },
  @{ n='tema: datos y cifras';         c='BFD4F2'; d='Exactitud o trazabilidad de un numero' },
  @{ n='tema: accesos';                c='BFD4F2'; d='Quien puede ver o hacer que' },
  @{ n='tema: obra';                   c='BFD4F2'; d='Actividades de campo y medicion' },
  @{ n='tema: nomina';                 c='BFD4F2'; d='Personal, horas y novedades' },
  @{ n='tema: compras';                c='BFD4F2'; d='Proveedores, cotizaciones y ordenes' },
  @{ n='tema: contabilidad';           c='BFD4F2'; d='Causacion, cuentas y cierres' },
  @{ n='tema: documentos';             c='BFD4F2'; d='Archivos, firmas y expedientes' },
  # Prioridad
