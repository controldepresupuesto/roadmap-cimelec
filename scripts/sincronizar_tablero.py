...
MAPA = {
    ...
    # El icono va en el NOMBRE de la opcion del tablero: es lo que hace reconocible la app
    # de un vistazo. Si se cambia aqui, hay que cambiarlo tambien en configurar_tablero.py.
    "Herramienta": {
